...
<link rel="stylesheet" href="../resources/css/widget-todolist.css">
...
<script type="text/x-template" id="todo-item-template">
    ...
    <a href="#" class="todo-remove" title="지우기">
...
<script type="text/x-template" id="todo-stats-template">
    <span class="todo-count">
        ...
        <span class="todo-remaining-label">{remainingLabel}</span> 할 일이 남았습니다.
    </span>

	<a href="#" class="todo-clear">
        완료한 <span class="todo-done">{numDone}</span>
    <span class="todo-done-label">{doneLabel} 삭제</span>
    </a>
...
TodoAppView = Y.TodoAppView = Y.Base.create('todoAppView', Y.View, [], {
    ...
    render: function () {
        ...
        stats.setContent(Y.Lang.sub(this.template, {
            ...
            doneLabel     : numDone === 1 ? '개' : '개',
            remainingLabel: numRemaining === 1 ? '개' : '개'
        }));
...
new TodoAppView();
    ...
    <body>
   	<div id="todo-app">
    <label class="todo-label" for="new-todo">To Do List</label><br/>
