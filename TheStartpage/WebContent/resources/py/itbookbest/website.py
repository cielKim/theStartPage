...
# 알라딘 서점 웹디자인/홈페이지 Best 10
html = urlopen("http://www.aladin.co.kr/shop/common/wbest.aspx?BestType=Bestseller&BranchType=1&CID=6348")
...
print("알라딘 웹사이트 Best 10 : "+str(indexAladin)+" 권")

# 교보문고 웹사이트 Best 5
html = urlopen("http://www.kyobobook.co.kr/categoryRenewal/categoryMain.laf?linkClass=3319&mallGb=KOR&orderClick=JAR")
bsObj = BeautifulSoup(html.read().decode('euc-kr','ignore'), "html.parser")
...
print("교보문고 웹사이트 Best 5 : "+str(indexKyobo)+" 권")

# 교보문고 웹프로그래밍 Best 5
html = urlopen("http://www.kyobobook.co.kr/categoryRenewal/categoryMain.laf?linkClass=3314&mallGb=KOR&orderClick=JAR")
bsObj = BeautifulSoup(html.read().decode('euc-kr','ignore'), "html.parser")
...
print("교보문고 웹프로그래밍 Best 5 : "+str(indexKyobo)+" 권")

# Yes24 웹사이트 Best 10
html = urlopen("http://www.yes24.com/24/category/bestseller?CategoryNumber=001001003020&sumgb=08")
bsObj = BeautifulSoup(html.read().decode('euc-kr','ignore'), "html.parser")
...
print("Yes24 웹사이트 Best10 : "+str(indexYes24)+"권")

websiteTotal = set(aladin+kyobo+yes24)
print("< 3사 통합한 웹사이트 서적 수 :"+str(len(websiteTotal))+"권 >")
...
sql = """delete from itbookbest where category = '웹사이트'"""
cursor.execute(sql)

for bookIsbn13 in websiteTotal:
