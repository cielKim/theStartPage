...
# 알라딘 서점 PC/게임/디지털카메라내 게임 Best 10
html = urlopen("http://www.aladin.co.kr/shop/common/wbest.aspx?BestType=Bestseller&BranchType=1&CID=6346")
...
print("알라딘 게임 Best10 : "+str(indexAladin)+" 권")

# 교보문고 게임 Best 10
html = urlopen("http://www.kyobobook.co.kr/categoryRenewal/categoryMain.laf?linkClass=3313&mallGb=KOR&orderClick=JAR")
bsObj = BeautifulSoup(html.read().decode('euc-kr','ignore'), "html.parser")
...
print("교보문고 게임 Best10 : "+str(indexKyobo)+" 권")

# Yes24 게임 Best 10
html = urlopen("http://www.yes24.com/24/category/bestseller?CategoryNumber=001001003027&sumgb=08")
bsObj = BeautifulSoup(html.read().decode('euc-kr','ignore'), "html.parser")
...
print("Yes24 게임 Best10 : "+str(indexYes24)+"권")

gameTotal = set(aladin+kyobo+yes24)
print("< 3사 통합한 게임 서적 수 :"+str(len(gameTotal))+"권 >")
...
sql = """delete from itbookbest where category = '게임'"""
cursor.execute(sql)

for bookIsbn13 in gameTotal:
